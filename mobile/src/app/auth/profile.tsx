...
export default function Profile() {
  const router = useRouter();
  const { user, userId, token, isCheckingAuth, checkAuth, logout } =
    useAuthStore() as {
      user: any;
      userId: string;
      token: string;
  ...
  // }, [isCheckingAuth]);
  if (!userId || !token) {
    // If user is not authenticated, show a message and a button to go to login
    return (
      <SafeAreaView
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            {/* Back Button - Now properly working */}
            <TouchableOpacity
              onPress={() => router.back()}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            {/* <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>User ID</Text>
              <Text style={styles.infoValueMonospace} selectable>
        ...
        <View style={styles.versionContainer}>
          <Text style={styles.versionText}>Version 1.0.0</Text>
          <Text style={styles.createdByText}>Created By @Himanshu</Text>
        </View>
      </ScrollView>
